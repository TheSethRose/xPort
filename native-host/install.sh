...
if [ $# -lt 1 ]; then
  ...
  echo "Firefox ID default: xport@sethrose.dev (from manifest.firefox.json)"
  exit 1
fi
...
echo ""
echo "Output directory (set XPORT_OUTPUT_DIR to change):"
...
echo ""
echo "Hosted API forwarding (re-run install after setting):"
