...
Video transcripts are stored on the matching `tweet_media` row. The daemon enforces one active transcription, a 90s duration cap, a 75MB fetched-video cap, and temporary-file cleanup after success or failure.
